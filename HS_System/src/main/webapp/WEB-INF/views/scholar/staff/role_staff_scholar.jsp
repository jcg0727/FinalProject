...
<div class="card">
  <div class="card-header with-border" style="height: 50px; border-bottom-width: 3px; border-bottom-color: #2A5F9E;"><h5 style="font-weight: bold; padding-top: 5px;">학생정보 상세조회</h5></div>
    <div class="card-body" style="text-align:left; padding-bottom: 0; padding-top: 7px;">
		...
		<div class="row" style="padding: 0 10px 0 10px;">
			...
			<div class="form-group col-3" style="padding:33px 10px 5px 10px;">
				<button type="button" id="confirm" class="btn btnBlue btn-sm text-white"  onclick="confirm_c();" style="height:35px;">추천</button>
				<button type="button" id="refer" class="btn btnRed btn-sm text-white" onclick="refer_b();" style="height:35px;">취소</button>
			</div>
		</div>
