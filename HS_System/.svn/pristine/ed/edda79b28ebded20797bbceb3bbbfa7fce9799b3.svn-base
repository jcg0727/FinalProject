package kr.ac.hs.dto.lecture;

public class LectureVO {
	public String lecture_semester;
	public String lecture_semester2;
	public String lecture_semester3;
	public String lecture_semester4;
	...
	private String lecture_summary;
	private String textbook_main;
	private String textbook_sub;
	...
	private String week_9;
	private String week_10;
	...
	public String getBefore_open() {
		return before_open;
	}

	public void setBefore_open(String before_open) {
	...
	public String getLecture_summary() {
		return lecture_summary;
	}

	public void setLecture_summary(String lecture_summary) {
		this.lecture_summary = lecture_summary;
	}

	public String getTextbook_main() {
		return textbook_main;
	}

	public void setTextbook_main(String textbook_main) {
		this.textbook_main = textbook_main;
	}

	public String getTextbook_sub() {
		return textbook_sub;
	}

	public void setTextbook_sub(String textbook_sub) {
		this.textbook_sub = textbook_sub;
	}
	...
	public String getWeek_9() {
		return week_9;
	}

	public void setWeek_9(String week_9) {
		this.week_9 = week_9;
	}

	public String getWeek_10() {
		return week_10;
	}

	public void setWeek_10(String week_10) {
		this.week_10 = week_10;
	}

	public String getLecture_semester2() {
		return lecture_semester2;
	}

	public void setLecture_semester2(String lecture_semester2) {
		this.lecture_semester2 = lecture_semester2;
	}

	public String getLecture_semester3() {
		return lecture_semester3;
	}

	public void setLecture_semester3(String lecture_semester3) {
		this.lecture_semester3 = lecture_semester3;
	}

	public String getLecture_semester4() {
		return lecture_semester4;
	}

	public void setLecture_semester4(String lecture_semester4) {
		this.lecture_semester4 = lecture_semester4;
	}
