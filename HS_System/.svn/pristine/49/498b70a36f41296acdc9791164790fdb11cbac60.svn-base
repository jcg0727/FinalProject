...
public class ScholarStaffVO {
	...
	public String toString() {
		return "ScholarStaffVO [recommend_date=" + recommend_date + ", student_no=" + student_no + ", scholar_amount="
				+ scholar_amount + ", status_cd=" + status_cd + ", dept_nm=" + dept_nm + ", name=" + name + ", no=" + no
				+ ", grade=" + grade + ", rank=" + rank + ", grades_avg=" + grades_avg + ", reScore=" + reScore
				+ ", semester=" + semester + ", rnum=" + rnum + ", totalcnt=" + totalcnt + "]";
	}
