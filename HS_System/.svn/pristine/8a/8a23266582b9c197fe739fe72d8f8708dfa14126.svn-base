...
public class LectureManagemenProfCommand {
	
	private String class_no;
	private String class_name;
	private String class_grade;
	private String class_day;
	private String class_apply;
	...
	public String getClass_apply() {
		return class_apply;
	}
	public void setClass_apply(String class_apply) {
		this.class_apply = class_apply;
	}	
