...
<!--                   <th style="width: 55px;">NO</th> -->
              ...
              <c:forEach items="${counselList }" var="c">
                   ...
                   <td> <button type="button" class="btn btn-xs btnBlue text-white" style="background-color:#2A5F9E;" onclick="OpenWindow('https://192.168.45.70:9001?counsel_no=${c.counsel_no}#1','',1000,700);">상담실 입장</button></td>                      
                  	</c:if>
                   <c:if test="${c.status_nm eq '신청완료' }"> 
                   <td> <button disabled="disabled" type="button" class="btn btn-xs btnBlue text-white" style="background-color:#2A5F9E;" onclick="OpenWindow('https://192.168.45.70:9001?counsel_no=${c.counsel_no}#1','',1000,700);">상담실 입장</button></td>                      
                  	</c:if>
